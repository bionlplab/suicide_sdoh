...
LABELS = {'3_class': ['Social community context', 'Behavior and lifestyle', 'Economic stability'],
          ...
          '16_class': ['crisisintimatepartnerproblem_c', 'crisisfamilyrelationship_c', 'crisiscriminal_c', 'crisisalcoholproblem_c', 'crisismentalhealth_c', 'crisisfinancial_c', 'crisisjob_c', 'crisissubstanceabuse_c', 'crisiseviction_c', 'crisisrelationshipproblemoth_c', 'crisisschool_c', 'crisiscivillegal_c', 'crisisrecsuicidefriendfamily_c']}

DATASETS = {'3_class': {'train': '/data/crisis/3class/train.csv',
                        'test': '/data/crisis/3class/test.csv'},
            '7_class': {'train': '/data/crisis/7class/train.csv',
                        'test': '/data/crisis/7class/test.csv'},
            '16_class': {'train': '/data/crisis/16class/train.csv',
                        'test': '/data/crisis/16class/test.csv'}}
